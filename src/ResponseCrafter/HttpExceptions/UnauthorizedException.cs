...
/// <summary>Exception that maps to an HTTP 401 Unauthorized response.</summary>
...
public class UnauthorizedException(string message = UnauthorizedException.DefaultMessage) : ApiException(401, message)
{
    ...
    /// <summary>Throws an <see cref="UnauthorizedException" /> when the value is null.</summary>
    ...
    /// <summary>Throws an <see cref="UnauthorizedException" /> when the sequence is null or empty.</summary>
    ...
    /// <summary>Throws an <see cref="UnauthorizedException" /> when the string is null, empty, or whitespace.</summary>
    ...
    /// <summary>Throws an <see cref="UnauthorizedException" /> when the condition is true.</summary>
    ...
    /// <summary>Throws an <see cref="UnauthorizedException" /> when the value is null or negative.</summary>
