...
/// <summary>Exception that maps to an HTTP 403 Forbidden response.</summary>
/// <param name="message">Error message describing why access is forbidden.</param>
public class ForbiddenException(string message = ForbiddenException.DefaultMessage) : ApiException(403, message)
{
    ...
    /// <summary>Throws a <see cref="ForbiddenException" /> when the value is null.</summary>
    ...
    /// <summary>Throws a <see cref="ForbiddenException" /> when the sequence is null or empty.</summary>
    ...
    /// <summary>Throws a <see cref="ForbiddenException" /> when the string is null, empty, or whitespace.</summary>
    ...
    /// <summary>Throws a <see cref="ForbiddenException" /> when the condition is true.</summary>
    ...
    /// <summary>Throws a <see cref="ForbiddenException" /> when the value is null or negative.</summary>
